...
function loaddata() {
    ...
    var BeginTime = $('#BeginTime1').timespinner('getValue');
    var EndTime = $('#EndTime1').timespinner('getValue');
    ...
    Ajax(true, mj["GetEventRecorderMjTimePageList"], { LoginID: LocalID, BeginDate: BeginDate, EndDate: EndDate, BeginTime: BeginTime, EndTime: EndTime, user_name: user_name, depart_name: depart_name, door_name: door_name, sortName: sortName, event_reason: inOutNull, sortOrder: (sortOrder == "asc" ? false : true), pageSize: PageSize, pageNum: PageNum
    }, function (data) {
        XCommon.ClosWating();
        if (!data.Success) {
            alert(data.Message);
...
var ResetInput = function () {
    var t1 = XCommon.getLastFormatDate();
    $('#BeginDate1').datebox('setValue', t1);
    var t2 = XCommon.getNowFormatDate();
    $('#EndDate1').datebox('setValue', t2);
    $('#BeginTime1').timespinner('setValue', '08:00');
    $('#EndTime1').timespinner('setValue', '10:00');
...
var fileConfirmClick = function () {
    ...
    if (display == 'block') {
        ...
        var BeginTime1 = $('#BeginTime1').timespinner('getValue');
        ...
        var url = RTURL + global.export["ExportEventRecorderMjTimePageFile"] + "?LoginID=" + LocalID + "&BeginDate=" + BeginDate1 + "&EndDate=" + EndDate1 + "&BeginTime=" + BeginTime1 + "&EndTime=" + EndTime1 + "&depart_name=" + depart_name1 + "&user_name=" + user_name1 + "&door_name=" + door_name1 + "&event_reason=" + inOutNull + "&di=" + di + "&columname=" + myData + "&exporttype=" + kinds + "&sortName=" + yilai + "&sortOrder=" + (paixu == "asc" ? false : true) + "&pageSize=" + "100000" + "&pageNum=" + "1";
        XCommon.ClosWating();
        window.open(url);
